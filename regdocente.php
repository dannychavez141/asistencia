                ...
                <div class="col-lg-6 contact-right-wthree-info login">
                    ...
                    <form action="modelos/cdocente.php" method="post">
                         <div class="form-group mt-4">
                            ...
                            <input type="text" class="form-control" id="validationDefault01" maxlength="8"name="tlog" onkeypress="return esInteger(event)" value="" required="" placeholder="Ingrese Dni">
                        </div>
                        <div class="form-group mt-4">
                            <label>Nombres:</label>

                            <input type="text" class="form-control" id="validationDefault01" value="" onkeypress="return validar(event)" maxlength="15" name="tnom" required="" placeholder="Ingrese Nombres">
                        </div><div class="form-group mt-4">
                            <label>Apellido Paterno:</label>

                            <input type="text" class="form-control" id="validationDefault01" value="" name="tapepa" required="" onkeypress="return validar(event)" maxlength="15" placeholder="Ingrese Apellido Paterno">
                        </div><div class="form-group mt-4">
