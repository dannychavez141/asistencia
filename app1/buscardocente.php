<?php
  include_once'./conexion.php'; 
    ...
    $query = "SELECT * FROM docente where concat(idDoc,nomDoc,apepaDoc,apemaDoc,dni) like '%%';";

    if (isset($_POST['consulta'])) {
        $q = $conn->real_escape_string($_POST['consulta']);
        $query = "SELECT * FROM docente where concat(idDoc,nomDoc,apepaDoc,apemaDoc,dni) like '%$q%';";
    }
