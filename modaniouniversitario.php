...
<body>
    ...
    <section class="about py-3">
        <div class="container py-md-3">
            <h3 class="tittle-wthree text-center">Modificando Año Universitario</h3>
         <center>
                <div class="col-lg-6 contact-right-wthree-info login">
                    <h5 class="text-center mb-4"></h5>
                    <form action="modelos/caniouniversirario.php" method="post">
                       <?php $url="SELECT * FROM asistencia.anioacademico a join estados e on a.est=e.idestados where idAnioAcademico=$id;";
  ...
  while ($fila = $docente->fetch_array()) {
                       ...
                       ?>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="text" class="form-control" id="validationDefault01" value="<?php echo $fila[1];?>" maxlength="30" name="tnom" required="" placeholder="Ingrese Nombres">
                        </div>
